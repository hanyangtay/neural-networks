...
def affine_batch_relu_backward(dout, cache):
  ...
  da = relu_backward(dout, relu_cache)
  dxhat, dgamma, dbeta = batchnorm_backward(da, batch_cache)
  dx, dw, db = affine_backward(dxhat, fc_cache)
  return dx, dw, db, dgamma, dbeta

def conv_bn_relu_pool_forward(x, w, b, conv_param, bn_param, gamma, beta, pool_param):
  """
  Convenience layer that performs a convolution, a ReLU, and a pool.
